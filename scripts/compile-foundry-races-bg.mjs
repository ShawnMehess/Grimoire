...
// Compiles docs/New Info/5e-races.txt and docs/New Info/5e-backgrounds.txt into runtime bundles.
...
const RACES_INPUT = path.join(ROOT, "docs", "New Info", "5e-races.txt");
const BG_INPUT = path.join(ROOT, "docs", "New Info", "5e-backgrounds.txt");
