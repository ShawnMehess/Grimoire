...
//
// Compiles the Foundry VTT exports in `docs/New Info/` into the site's baked
...
//
// Reads:
//   docs/New Info/5e-spells.txt   (NDJSON, one object per line)
//   docs/New Info/5e-items.txt
//
// Writes:
...
async function main() {
  ...
  const out = `// Auto-generated by scripts/compile-foundry-catalogs.mjs from docs/New Info/5e-spells.txt\n`
    + `// and docs/New Info/5e-items.txt. Do not hand-edit — re-run\n`
