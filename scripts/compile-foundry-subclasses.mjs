...
//
// Compiles `New Info/5e-subclasses.txt` (127 Foundry subclass entries)
...
const INPUT = path.join(ROOT, "New Info", "5e-subclasses.txt");
...
async function main() {
  ...
  const out = `// Auto-generated by scripts/compile-foundry-subclasses.mjs from New Info/5e-subclasses.txt.\n`
