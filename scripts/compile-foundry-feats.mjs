...
//
// Compiles the Foundry VTT feat export in `docs/New Info/5e-feats.txt`
...
//
// Re-run after updating docs/New Info/5e-feats.txt:
...
if (!fullText) continue;
  ...
  const out = `// Auto-generated by scripts/compile-foundry-feats.mjs from docs/New Info/5e-feats.txt.\n`
